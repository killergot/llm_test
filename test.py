...
if __name__ == "__main__":
    ...
    try:
        text = "мой email test@example.com и ключ sk-12345678901234567890"
        print("До:", text)
        processed = engine.apply(text, stage="pre")
        processed = engine.apply(processed, stage="post")
        print("После:", processed)

    except PolicyViolation as e:
        print("Текст заблокирован:", e)
